...
const LoadingRow = () => (
  <tr className="border-b border-white/5">
    <td colSpan={6} className="px-4 py-6 text-center text-sm text-gray-500">Ładowanie...</td>
  </tr>
);

const EmptyRow = () => (
  <tr className="border-b border-white/5">
    <td colSpan={6} className="px-4 py-6 text-center text-sm text-gray-500">Brak użytkowników spełniających kryteria.</td>
  </tr>
);
          ...
          <table className="min-w-full divide-y divide-white/5">
            ...
            <tbody className="divide-y divide-white/5 text-sm">
              {loading ? (
                ...
                <tr className="border-b border-white/5">
                  <td colSpan={6} className="px-4 py-6 text-center text-sm text-rose-300">{error}</td>
                </tr>
              ) : users.length === 0 ? (
                <EmptyRow />
              ) : (
